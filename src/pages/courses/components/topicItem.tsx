...
const TopicItem = ({ item, onSelect, isActive }: Props) => {
  return (
    <div
      onClick={onSelect}
      className={` ${isActive ? "border-l-4 border-l-primary border-b border-b-primary text-[#0A2540]" : ""} hover:border-l-4 hover:border-l-primary hover:pl-3 hover:border-b-primary hover:text-[#0A2540] border-b py-5 pl-2 text-[#64748B] flex gap-3 transition-all duration-100 delay-75`}
    >
      <div
