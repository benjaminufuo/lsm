...
const SignIn: FC = () => {
  ...
  return (
    <div className="min-h-screen flex">
        ...
        <div className="relative left-[100px] top-[50px] z-10 flex flex-col justify-center p-12 text-white">
          ...
          <div className=" flex gap-4 flex-wrap">
            {stats.map((stat) => (
              <div
                key={stat.label}
                className="h-25 w-25  bg-purple-500 bg-opacity-50 backdrop-blur-sm rounded-lg px-6 py-4 text-white"
              >
      ...
      {/* Right Side - Form */}
      <div className="w-full md:w-2/5 bg-white flex flex-col justify-center px-8 py-12 md:px-16">
